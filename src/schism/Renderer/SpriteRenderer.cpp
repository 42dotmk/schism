...
void SpriteRenderer::Draw(Components::Transform2D& transformComponent,
                          Components::Sprite& spriteComponent,
                          const glm::mat4& proj) {
    glm::mat4 transform =
        glm::translate(glm::mat4(1.f), transformComponent.position);
    transform = glm::translate(
        transform, glm::vec3(0.5f * transformComponent.scale.x,
                             0.5f * transformComponent.scale.y, 0.0f));
    transform =
        glm::rotate(transform, glm::radians(transformComponent.rotation),
...
void SpriteRenderer::Draw(Components::Transform2D& transform,
