...
#define SC_EVENT(type, category) [[nodiscard]] EventType GetEventType() const override { return type; } \
						static constexpr EventType GetStaticType() { return type; } \
                        static constexpr EventCategory GetStaticCategory() { return category; } \
                        [[nodiscard]] EventCategory GetCategory() const override { return category; }
