...
inline void PrependMessageType(std::vector<uint8_t>& vec,
...
struct EnterGame {
        ...
        inline static constexpr MessageType Type() { return ENTER_GAME; }
...
struct GameMove {
        ...
        inline static constexpr MessageType Type() { return GAME_MOVE; }
...
struct SuccessfulMove {
        ...
        inline static constexpr MessageType Type() { return SUCCESSFUL_MOVE; }
...
struct FailedMove {
        ...
        inline static constexpr MessageType Type() { return FAILED_MOVE; }
